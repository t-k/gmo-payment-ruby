    ...
    context 'with valid options', :vcr do
      ...
      it "makes request with correct parameters" do
        ...
        args = {
          ...
          # "Remit_Method_Sevenatm"     => options[:remit_method_sevenatm],
          # "Sevenatm_Payment_Term_Day" => options[:sevenatm_payment_term_day],
          # "Remit_Method_Amazongift"   => options[:remit_method_amazongift],
          # "Remit_Method_Aupay"        => options[:remit_method_aupay],
